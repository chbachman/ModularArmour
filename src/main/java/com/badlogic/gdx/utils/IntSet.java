...
public class IntSet {
    ...
    /**
     * Creates a new sets with an initial capacity of 32 and a load factor of
     * 0.8. This set will hold 25 items before growing the backing table.
     */
    public IntSet() {
        this(32, 0.8f);
    }
     ...
     * This set will hold initialCapacity * loadFactor items before growing the
     * backing table.
     */
