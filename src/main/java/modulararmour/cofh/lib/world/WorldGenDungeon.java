package modulararmour.cofh.lib.world;

import static java.lang.Math.abs;
import static modulararmour.cofh.lib.world.WorldGenMinableCluster.canGenerateInBlock;
import static modulararmour.cofh.lib.world.WorldGenMinableCluster.generateBlock;

import java.util.Arrays;
import java.util.List;
import java.util.Random;

import modulararmour.cofh.lib.util.WeightedRandomBlock;
import modulararmour.cofh.lib.util.WeightedRandomNBTTag;
