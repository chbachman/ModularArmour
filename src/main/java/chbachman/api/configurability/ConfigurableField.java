...
public class ConfigurableField extends NBTStorage<Percentage>{
	...
	/**
	 * Constructed with the given upgrade-unique identifier and the default data
	 * of 0.
	 * 
	 * @param u
	 * @param name
	 ...
	 * 
	 * @param key
	 *            - For saving and loading from NBT data on the Armour Piece.
	 * @param displayName
	 *            - For displaying to the user. Will be translated.
	 * @param defaultData
	 *            - The data to default to if first created.
	 */
