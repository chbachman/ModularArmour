...
public class UpgradeElectricCapacity extends Upgrade{
	...
	public Recipe getRecipe() {
	    ...
	    return new Recipe(this, "iri", "rur", "iri", 'i', Items.iron_ingot, 'r', Items.redstone, 'u', upgrade.recipe);
	}
	...
	public void onUpgradeAddition(ItemModularArmour armour, ItemStack stack){
	    armour.capacity.set(stack, upgrade.capacity);
	    armour.maxTransfer.set(stack, upgrade.maxTransfer);
	}
	...
	public static enum ElectricUpgrades {
	    ...
	    COBBLESTONE("Cobblestone Upgrade", Item.getItemFromBlock(Blocks.cobblestone), 1000, 100),
	    IRON("Iron Upgrade", Items.iron_ingot, 10000, 1000),
	    GOLD("Gold Upgrade", Items.gold_ingot, 100000, 10000),
	    DIAMOND("Diamond Upgrade", Items.diamond, 1000000, 10000)
	    ;
